...
function loadActiveX() {
	if(navigator.userAgent.indexOf('MSIE') >= 0) {
		...
		//其他浏览器加载控件
		document.getElementById("ActiveXDivOne").innerHTML = " <canvas id=\"cameraCanvas\" width=\"800px\" height=\"500px\">";
		/*document.getElementById("ActiveXDivOne").innerHTML = '<canvas id="cameraCanvas" style="width:100%;height:400px;">';*/
